...
This is for a Discord AI Bot using the discord.py wrapper. Started off as just a music bot, but very quickly grew to include many other featurse based on request of friends. The Bot in total took be about 2 weeks to complete and was one of my favorite projects to work on(Due to me using almost everyday).
